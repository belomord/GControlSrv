...
namespace DeviceMgmt
{
  public class Win32DeviceMgmt
  {
    ...
    //https://msdn.microsoft.com/ru-ru/library/windows/hardware/ff551967(v=vs.85).aspx
    public const UInt32 SPDRP_FRIENDLYNAME = 0x0000000C;
    public const UInt32 SPDRP_ADDRESS = 0x00000000;
    public const UInt32 SPDRP_BUSNUMBER = 0x00000000;
    public const UInt32 SPDRP_ENUMERATOR_NAME = 0x00000000;
    public const UInt32 SPDRP_HARDWAREID = 0x00000000;
    ...
    public const string GUID_DEVINTERFACE_DISPLAY_ADAPTER = "5B45201D-F2F2-4F3B-85BB-30FF1F953599"; 
    ...
    {
      Guid guidComPorts = new Guid(GUID_DEVINTERFACE_DISPLAY_ADAPTER);
      ...
      try
      {
        ...
        while (true)
        {
          ...
          //deviceInfo.name = GetDeviceDescription(hDeviceInfoSet, deviceInfoData, SPDRP_FRIENDLYNAME);
          deviceInfo.decsription = GetDeviceDescription(hDeviceInfoSet, deviceInfoData, SPDRP_DEVICEDESC);
    ...
    private static string GetDeviceDescription(IntPtr hDeviceInfoSet, SP_DEVINFO_DATA deviceInfoData, uint property)
    {
