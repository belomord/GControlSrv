...
namespace Belomor.MessageBoxEx
{
  ...
  public class MessageBoxWithTimeout
  {
    ...
    public static DialogResult Show(/*IWin32Window owner,*/ string message, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defButton, uint uTimeout)
    {
      DialogResult result;

      result = (DialogResult)Show(IntPtr.Zero, message, caption, (uint)buttons | (uint)icon | (uint)defButton, (Int32)uTimeout);

      return result;
    }

    /*
    public static DialogResult Show(string message, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defButton, uint uTimeout)
    {
      return Show(IntPtr.Zero, message, caption, icon, defButton, uTimeout);
    }
    */
  }
}